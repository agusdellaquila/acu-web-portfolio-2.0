const ContactCard = () => {
    return(
        <div className="theme-bg-alt shadow-lg rounded-2xl h-max-content py-4 mt-6">
            ...
            <div className="my-2 grid grid-cols-2 content-center mt-2 gap-y-6">
